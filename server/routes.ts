import { evaluateQuizPOV, generateBenchmarkComparison, generateProactiveInsights, generateLogicResponse, generateAdaptiveResponseStream, generateAdaptiveResponse } from "./gemini";
